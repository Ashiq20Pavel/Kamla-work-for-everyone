...
namespace Server
{
    ...
    public partial class Server : Form
    {
        ...
        {
            textBox1.Text = kamla1.Form1.seekerName;
            textBox2.Text = kamla1.Form1.recruiterName;
            if (R.Name == kamla1.Form1.seekerName)
            {
                //serverside.SendTo(kamla1.Form1.recruiterName, R.Name + " : " + R.ReceivedData);
                serverside.BroadCast(R.Name + " : " + kamla1.Form1.recruiterName);
                ChangeTextBoxContents(R.Name + " : " + R.ReceivedData);
            }

            else if (R.Name == kamla1.Form1.recruiterName)
            {
                //serverside.SendTo(kamla1.Form1.seekerName, R.Name + " : " + R.ReceivedData);
